...
<html>
<head>
	<title>Owner - Tambah staff</title>
		...
		<div class="row putih2">
			<div class="col-md-12">
				...
				<div class="col-md-9 menutengahter">
					...
					<div class="table-responsive">
						<table class="table">
						<?php echo form_open('owner/staff/doTambahPegawai') ?>
						<tr><td><b>Nama</b></td><td><input type="text" name="nama_pegawai" class="form-control"></td></tr>
						<tr><td><b>Email</b></td><td><input type="text" name="email_pegawai" class="form-control"></td></tr>
						<tr><td><b>no. Hp</b></td><td><input type="text" name="nohp_pegawai" class="form-control"></td></tr>
						<tr><td><b>alamat</b></td><td><textarea name="alamat_pegawai"></textarea></td></tr>
