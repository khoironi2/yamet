...
<!-- 		<div class="btnHlogin">
		...
		<div class="row hijau1">
			...
			<div class="col-md-4"><a style="color: white; font-size: 20px;"  href="<?php echo site_url('home')?>"><b>News</b></a></div>
			<div class="col-md-4"><a style="color: white; font-size: 20px;" href="#"><b>Jenis Terapi</b></a></div>
		</div>
