		...
		<div class="row putih2">
			...
			<div class="col-md-3">
				...
				<div class="col-md-9 menutengah">
					<h5><b><i>Tambah Layanan</i></b></h5>
					
					<div class="table-responsive">
						<?php echo form_open_multipart('admin/fasilitas/doUpdate'); ?>
					<table class="table">
						<tr><td>Isi</td>
							<td><input type="text" name="id_fasilitas" value="<?php echo $fasilitas->id_fasilitas ?>" hidden>
