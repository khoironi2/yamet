...
<!-- 		<div class="btnHlogin">
		...
		<div class="row menudepannews">
			...
			<?php echo form_hidden('id_post',$this->uri->segment(3)); ?>
				<table class="table">
					<?php foreach ($postberita as $ber) { ?>
					<tr>
						<th colspan="2"><h1><b> <?php  echo $ber->judul_post; ?> </b></h1></th>
					</tr>
					<tr>
						<td><img src="<?php echo base_url('assets/upload/post/'.$ber->gambar_post) ?>" alt="gambar" height="150px"></td>
						<td> <?php  echo $ber->isi_post; ?> </td>
					</tr>
					<?php	} ?>
				</table>
